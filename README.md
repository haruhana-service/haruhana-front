...
> ⚠️ Safari에서만 설치 가능합니다. Chrome 등 다른 브라우저는 지원하지 않아요.

### 안드로이드 (Chrome)

1. Chrome에서 서비스 접속
2. 주소창 오른쪽 **설치 버튼** 탭 (또는 우측 상단 메뉴 → **"앱 설치"**)
3. **설치** 탭

> 배너가 뜨지 않으면: 우측 상단 ⋮ 메뉴 → **홈 화면에 추가** 선택

### 🔔 알림 허용

매일 문제 풀이 시간을 놓치지 않도록 알림을 허용해주세요.

**아이폰**
1. 앱 설치 후 홈 화면에서 앱 실행
2. 알림 허용 팝업 → **허용** 탭
3. 허용 안 했다면: **설정** → **하루하루** → **알림** → 허용

**안드로이드**
1. 앱 실행 시 알림 허용 팝업 → **허용** 탭
2. 허용 안 했다면: **설정** → **앱** → **하루하루** → **알림** → 허용
