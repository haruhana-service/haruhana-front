    ...
    <div className="flex flex-col animate-fade-in">
      ...
      <Card className="mb-4 !p-3">
        <div className="flex justify-between items-center mb-2">
          <button
            ...
            className="p-1.5 text-slate-500 hover:text-slate-700 hover:bg-slate-50 rounded-lg transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
          >
          ...
          <button onClick={handleNextMonth} disabled={isNextDisabled} className="p-1.5 text-slate-500 hover:text-slate-700 hover:bg-slate-50 rounded-lg transition-colors disabled:opacity-40 disabled:cursor-not-allowed">
        ...
        <div className="grid grid-cols-7 gap-0.5 text-center mb-0.5">
          {['일', '월', '화', '수', '목', '금', '토'].map(d => (
            <div key={d} className="text-[10px] font-bold text-slate-400 py-0.5 uppercase">{d}</div>
          ))}
        </div>
      ...
      <div className="flex flex-col">
        <div className="flex items-center justify-between mb-2">
          ...
          {selectedDate && (
            <button onClick={handleResetToToday} className="text-[12px] text-haru-600 font-semibold hover:text-haru-700 transition-colors">전체 보기</button>
          )}
        </div>
