export function Header() {
  return (
    <header className="shrink-0 h-16 glass border-b border-white/40 flex items-center justify-between px-6 z-30 sticky top-0">
      <div className="mx-auto max-w-md w-full flex items-center justify-between">
        {/* Logo */}
        ...
        {/* User Icon */}
        <button className="w-10 h-10 rounded-xl flex items-center justify-center transition-all active:scale-90 border border-slate-200 bg-white text-slate-500 shadow-sm hover:bg-slate-50">
